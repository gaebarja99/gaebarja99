...
| **GameMatcher**<br><sub>(팀 프로젝트)</sub> | **게이머들을 위한 전적 검색 및 실시간 매칭·채팅 플랫폼**<br>• 단일 레포지토리 관리 구조<br>• 핵심 기능 구동 시연 영상 및 PPT 포함 | Java, Spring Boot, React, WebSocket(STOMP), MySQL | [Repository](https://github.com/gaebarja99/game-matching-platform.git)<br>[Demo Video](https://drive.google.com/file/d/10vvO0tvCRcR1RpF-fbHd-9fUmhgqf6jJ/view?usp=sharing)<br>[PPT](https://canva.link/bwkivjhees3gg96) |
